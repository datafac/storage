...
namespace DTOMaker.CSPoco.Tests
{
    public class GenericsTests
    {
        ...
        public void Generic5_Nested1_CheckGeneratedSources()
        {
            ...
            grr.GeneratedSources[0].HintName.ShouldBe("MyOrg.Models.Base_1_Int64.CSPoco.g.cs");
            grr.GeneratedSources[1].HintName.ShouldBe("MyOrg.Models.Base_1_Octets.CSPoco.g.cs");
            grr.GeneratedSources[2].HintName.ShouldBe("MyOrg.Models.MyPoco1.CSPoco.g.cs");
            grr.GeneratedSources[3].HintName.ShouldBe("MyOrg.Models.MyPoco2.CSPoco.g.cs");
            grr.GeneratedSources[4].HintName.ShouldBe("MyOrg.Models.Poco_2_String_Int64.CSPoco.g.cs");
            grr.GeneratedSources[5].HintName.ShouldBe("MyOrg.Models.Poco_2_String_Octets.CSPoco.g.cs");
        }
