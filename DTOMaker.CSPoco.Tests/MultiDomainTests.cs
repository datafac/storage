...
namespace DTOMaker.CSPoco.Tests
{
    public class MultiDomainTests
    {
        ...
        public void Domains01_2Entities_Generates3Outputs()
        {
            ...
            generatorResult.GeneratedSources[0].HintName.Should().Be("DTOMaker.Common.EntityBase.CSPoco.g.cs");
            generatorResult.GeneratedSources[1].HintName.Should().Be("MyOrg.DomainA.MyDTO.CSPoco.g.cs");
            generatorResult.GeneratedSources[2].HintName.Should().Be("MyOrg.DomainB.MyDTO.CSPoco.g.cs");
        }
