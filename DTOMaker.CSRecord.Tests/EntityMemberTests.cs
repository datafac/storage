...
namespace DTOMaker.CSRecord.Tests
{
    public class EntityMemberTests
    {
        ...
        public void EntityMember00_GeneratedSourcesLengthShouldBe3()
        {
            ...
            generatorResult.GeneratedSources[0].HintName.ShouldBe("MyOrg.DomainA.MyDTO1.CSRecord.g.cs");
            generatorResult.GeneratedSources[1].HintName.ShouldBe("MyOrg.DomainB.MyDTO1.CSRecord.g.cs");
            generatorResult.GeneratedSources[2].HintName.ShouldBe("MyOrg.DomainC.MyDTO2.CSRecord.g.cs");
        }
