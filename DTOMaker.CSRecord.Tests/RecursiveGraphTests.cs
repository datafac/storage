...
namespace DTOMaker.CSRecord.Tests
{
    public class RecursiveGraphTests
    {
        ...
        public void RecursiveGraph00_GeneratedSourcesLengthShouldBe7()
        {
            ...
            generatorResult.GeneratedSources[0].HintName.ShouldBe("MyOrg.Models.BooleanNode.CSRecord.g.cs");
            generatorResult.GeneratedSources[1].HintName.ShouldBe("MyOrg.Models.DoubleNode.CSRecord.g.cs");
            generatorResult.GeneratedSources[2].HintName.ShouldBe("MyOrg.Models.Int64Node.CSRecord.g.cs");
            generatorResult.GeneratedSources[3].HintName.ShouldBe("MyOrg.Models.Node.CSRecord.g.cs");
            generatorResult.GeneratedSources[4].HintName.ShouldBe("MyOrg.Models.NumericNode.CSRecord.g.cs");
            generatorResult.GeneratedSources[5].HintName.ShouldBe("MyOrg.Models.StringNode.CSRecord.g.cs");
            generatorResult.GeneratedSources[6].HintName.ShouldBe("MyOrg.Models.Tree.CSRecord.g.cs");
        }
