...
{
    public partial class Other : DTOMaker.Runtime.JsonNewtonSoft.EntityBase, IOther, IEquatable<Other>
    {
        // Derived entities: 0
        ...
        public static new Other Empty => _empty;
        ...
        public new static Other CreateFrom(Other source)
        {
            ...
            {
                _ => new MyOrg.Models.JsonNewtonSoft.Other(source)
            };
        }
