...
Emit("{");
Emit("    public class T_MemberTypeName_ : EntityBase, IT_MemberTypeIntfName_");
Emit("    {");
Emit("        protected override int OnGetEntityId() => 3;");
Emit("");
Emit("        private static T_MemberTypeName_ CreateEmpty()");
Emit("        {");
Emit("            var empty = new T_MemberTypeName_();");
Emit("            empty.Freeze();");
Emit("            return empty;");
Emit("        }");
Emit("        private static readonly T_MemberTypeName_ _empty = CreateEmpty();");
Emit("        public static new T_MemberTypeName_ Empty => _empty;");
Emit("");
...
Emit("            _T_VectorMemberName_ = source.T_VectorMemberName_.ToArray();");
            ...
            case MemberKind.Entity:
            if (member.IsNullable) {
Emit("            _T_NullableEntityMemberName_ = source.T_NullableEntityMemberName_ is null ? null : T_MemberTypeNameSpace_.JsonNewtonSoft.T_MemberTypeName_.CreateFrom(source.T_NullableEntityMemberName_);");
            } else {
Emit("            _T_RequiredEntityMemberName_ = T_MemberTypeNameSpace_.JsonNewtonSoft.T_MemberTypeName_.CreateFrom(source.T_RequiredEntityMemberName_);");
            }
            break;
            case MemberKind.Binary:
            if (member.IsNullable) {
...
Emit("        ReadOnlyMemory<T_MemberType_> IT_EntityIntfName_.T_VectorMemberName_ => IsFrozen ? _T_VectorMemberName_ : _T_VectorMemberName_.ToArray().AsMemory();");
        ...
        case MemberKind.Entity:
        if (member.IsNullable) {
Emit("        private T_MemberTypeNameSpace_.JsonNewtonSoft.T_MemberTypeName_? _T_NullableEntityMemberName_;");
Emit("        public T_MemberTypeNameSpace_.JsonNewtonSoft.T_MemberTypeName_? T_NullableEntityMemberName_");
Emit("        {");
...
Emit("        private T_MemberTypeNameSpace_.JsonNewtonSoft.T_MemberTypeName_ _T_RequiredEntityMemberName_ = T_MemberTypeNameSpace_.JsonNewtonSoft.T_MemberTypeName_.Empty;");
Emit("        public T_MemberTypeNameSpace_.JsonNewtonSoft.T_MemberTypeName_ T_RequiredEntityMemberName_");
Emit("        {");
