...
namespace DTOMaker.MemBlocks.Tests
{
    public class GenericsTests
    {
        ...
        public void Generic1_Pair1_CheckGeneratedSources()
        {
            ...
            grr.GeneratedSources[0].HintName.ShouldBe("MyOrg.Models.MyDTO2.MemBlocks.g.cs");
            grr.GeneratedSources[1].HintName.ShouldBe("MyOrg.Models.MyDTO3.MemBlocks.g.cs");
            grr.GeneratedSources[2].HintName.ShouldBe("MyOrg.Models.Pair_2_Int64_String.MemBlocks.g.cs");
        }
        ...
        private readonly string source5 =
            ...
            namespace MyOrg.Models
            {
                [Entity][Id(100)][Layout(LayoutMethod.Linear)]
                public interface IBase<T>
                {
                    [Member(1)] T Value {get; set;}
                }
                [Entity][Id(101)][Layout(LayoutMethod.Linear)]
