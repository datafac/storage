    ...
    public class LinearLayoutTests
    {
        ...
        public async Task Happy01_NoMembers()
        {
            var inputSource =
                ...
                {
                    [Entity]
                    [Id(1)][Layout(LayoutMethod.Linear)]
        ...
        [Fact]
        public void Fault03_Unsupported_RefType()
        {
            var inputSource =
                """
                using System;
            ...
            errors[0].GetMessage().ShouldBe("MemberType 'System.Version' not supported");
        ...
        public void Fault05_EntityId_NotUnique()
        {
            ...
            var errors = generatorResult.Diagnostics.Where(d => d.Severity == DiagnosticSeverity.Error).ToArray();
            errors.Length.ShouldBe(1);
            errors[0].GetMessage().ShouldBe("Entity id (1) is already used by entity: MyOrg.Models.MyDTO1");
        }
