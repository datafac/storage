...
Emit("        public static T_MemberTypeName_ CreateFrom(T_MemberTypeName_ source) => throw new NotImplementedException();");
...
Emit("        protected override ValueTask OnPack(IDataStore dataStore) => throw new NotImplementedException();");
Emit("        protected override ValueTask OnUnpack(IDataStore dataStore) => throw new NotImplementedException();");
...
Emit("            BlobIdV1 blobId = default;");
Emit("            if (_T_RequiredEntityMemberName_ is not null)");
Emit("            {");
