...
Emit("            return new T_MemberTypeName_(source);");
Emit("        }");
Emit("        public static T_MemberTypeName_ CreateFrom(System.Buffers.ReadOnlySequence<byte> buffers)");
Emit("        {");
...
Emit("            }");
Emit("        }");
Emit("        public T_MemberTypeName_(System.Buffers.ReadOnlySequence<byte> buffers) : this(_header, SourceBlocks.ParseFrom(buffers)) { }");
Emit("");
...
Emit("        }");
Emit("");
Emit("        public new static T_EntityName_ CreateFrom(System.Buffers.ReadOnlySequence<byte> buffers)");
Emit("        {");
...
Emit("            _writableLocalBlock = Memory<byte>.Empty;");
Emit("        }");
Emit("        public T_EntityName_(System.Buffers.ReadOnlySequence<byte> buffers) : this(_header, SourceBlocks.ParseFrom(buffers))");
Emit("        {");
Emit("        }");
Emit("");
        if(false) {
