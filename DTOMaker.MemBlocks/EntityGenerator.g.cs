...
Emit("            get");
Emit("            {");
Emit("                ThrowIfNotUnpacked(_T_NullableEntityMemberName__isUnpacked);");
...
Emit("            get");
Emit("            {");
Emit("                ThrowIfNotUnpacked(_T_RequiredEntityMemberName__isUnpacked);");
Emit("                return _T_RequiredEntityMemberName_;");
Emit("            }");
Emit("            set");
Emit("            {");
Emit("                ThrowIfFrozen();");
