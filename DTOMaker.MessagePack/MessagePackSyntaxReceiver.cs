...
namespace DTOMaker.MessagePack
{
    ...
    internal class MessagePackSyntaxReceiver : SyntaxReceiverBase
    {
        ...
        private static TargetEntity EntityFactory(TargetDomain domain, TypeFullName entityName, Location location) => new MessagePackEntity(domain, entityName, location);
