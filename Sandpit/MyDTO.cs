...
namespace Sandpit
{
    public sealed partial class MyDTO : IMyDTO, IFreezable
    {
        ...
        public Half Field7
        {
            get => DTOMaker.Runtime.Codec_Half_LE.ReadFromSpan(_readonlyBlock.Slice(10, 2).Span);
            set => DTOMaker.Runtime.Codec_Half_LE.WriteToSpan(_writableBlock.Slice(10, 2).Span, IfNotFrozen(ref value));
        }
        ...
        {
            get => DTOMaker.Runtime.Codec_Int128_LE.ReadFromSpan(_readonlyBlock.Slice(64, 16).Span);
            set => DTOMaker.Runtime.Codec_Int128_LE.WriteToSpan(_writableBlock.Slice(64, 16).Span, IfNotFrozen(ref value));
        }

        public UInt128 Field16
        {
            get => DTOMaker.Runtime.Codec_UInt128_LE.ReadFromSpan(_readonlyBlock.Slice(80, 16).Span);
            set => DTOMaker.Runtime.Codec_UInt128_LE.WriteToSpan(_writableBlock.Slice(80, 16).Span, IfNotFrozen(ref value));
        }
