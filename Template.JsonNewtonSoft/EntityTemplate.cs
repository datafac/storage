    ...
    public partial class T_EntityName_ : T_BaseNameSpace_.JsonNewtonSoft.T_BaseName_, IT_EntityName_, IEquatable<T_EntityName_>
    {
        ...
        public new static T_EntityName_ CreateFrom(T_EntityName_ source)
        {
            ...
            return source switch
            {
                ...
                //##using var _ = NewScope(derived);
                T_NameSpace_.JsonNewtonSoft.T_EntityName_ source2 => new T_NameSpace_.JsonNewtonSoft.T_EntityName_(source2),
                //##}
                _ => new T_NameSpace_.JsonNewtonSoft.T_EntityName_(source)
            };
        }
        ...
        public new static T_EntityName_ CreateFrom(T_NameSpace_.IT_EntityName_ source)
        {
            ...
            return source switch
            {
                //##foreach(var derived in entity.DerivedEntities.OrderByDescending(e => e.ClassHeight)) {
                //##using var _ = NewScope(derived);
                T_NameSpace_.IT_EntityName_ source2 => new T_NameSpace_.JsonNewtonSoft.T_EntityName_(source2),
                //##}
                _ => new T_NameSpace_.JsonNewtonSoft.T_EntityName_(source)
            };
        }
        ...
        ReadOnlyMemory<T_MemberType_> IT_EntityName_.T_VectorMemberName_ => IsFrozen ? _T_VectorMemberName_ : _T_VectorMemberName_.ToArray().AsMemory();
        //##break;
        //##case MemberKind.Entity:
        //##if (member.IsNullable) {
        ...
        Octets? IT_EntityName_.T_NullableBinaryMemberName_ => _T_NullableBinaryMemberName_ is null ? null
        ...
        Octets IT_EntityName_.T_RequiredBinaryMemberName_ => IsFrozen ? Octets.UnsafeWrap(_T_RequiredBinaryMemberName_) : new Octets(_T_RequiredBinaryMemberName_);
        //##}
        //##break;
        //##case MemberKind.String:
        //##if (member.IsNullable) {
