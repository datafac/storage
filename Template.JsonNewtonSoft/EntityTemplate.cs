...
{
    public partial class T_EntityImplName_ : T_BaseNameSpace_.JsonNewtonSoft.T_BaseName_, IT_EntityIntfName_, IEquatable<T_EntityImplName_>
    {
        ...
        public new static T_EntityImplName_ CreateFrom(T_EntityImplName_ source)
        {
            ...
            return source switch
            {
                ...
                //##using var _ = NewScope(derived);
                T_NameSpace_.JsonNewtonSoft.T_EntityImplName_ source2 => new T_NameSpace_.JsonNewtonSoft.T_EntityImplName_(source2),
                //##}
                _ => new T_NameSpace_.JsonNewtonSoft.T_EntityImplName_(source)
            };
        }
        ...
        public new static T_EntityImplName_ CreateFrom(T_NameSpace_.IT_EntityIntfName_ source)
        {
            ...
            return source switch
            {
                //##foreach(var derived in entity.DerivedEntities.OrderByDescending(e => e.ClassHeight)) {
                //##using var _ = NewScope(derived);
                T_NameSpace_.IT_EntityIntfName_ source2 => new T_NameSpace_.JsonNewtonSoft.T_EntityImplName_(source2),
                //##}
                _ => new T_NameSpace_.JsonNewtonSoft.T_EntityImplName_(source)
            };
        }
        ...
        ReadOnlyMemory<T_MemberType_> IT_EntityIntfName_.T_VectorMemberName_ => IsFrozen ? _T_VectorMemberName_ : _T_VectorMemberName_.ToArray().AsMemory();
        //##break;
        //##case MemberKind.Entity:
        //##if (member.IsNullable) {
        ...
        Octets? IT_EntityIntfName_.T_NullableBinaryMemberName_ => _T_NullableBinaryMemberName_ is null ? null
            : IsFrozen ? Octets.UnsafeWrap(_T_NullableBinaryMemberName_) : new Octets(_T_NullableBinaryMemberName_);
        //##} else {
        ...
        Octets IT_EntityIntfName_.T_RequiredBinaryMemberName_ => IsFrozen ? Octets.UnsafeWrap(_T_RequiredBinaryMemberName_) : new Octets(_T_RequiredBinaryMemberName_);
        //##}
        //##break;
        //##case MemberKind.String:
        //##if (member.IsNullable) {
